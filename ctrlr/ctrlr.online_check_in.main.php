...
function ctrlr_online_check_in_pub_main(&$env){
    ...
    if($env['flags']['is_frid_pop']===TRUE || $env['flags']['is_step_view_on_error']===TRUE){
        ...
        $env['API']['SURVEY']['UPSELL'][0]=1442; # Upsell Item: Pre-Registration for $250
        $env['API']['SURVEY']['UPSELL'][1]=1443; # Upsell Item: Pre-Registration for $115
        $env['API']['SURVEY']['UPSELL'][2]=1441; # Upsell Item: Pre-Registration for $25
